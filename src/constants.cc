...
void InitConstants(Handle<Object> exports) {
  ...
  SET_CONSTANT_MEMBER(exports, Number, OC_MASK_FAMS);
  SET_CONSTANT_MEMBER(exports, Number, OC_MASK_MODS);
  SET_CONSTANT_MEMBER(exports, Number, OC_MASK_SCOPE);
  ...
  SET_CONSTANT_MEMBER(exports, String, OC_RSRVD_BASE_URI);
  ...
  SET_CONSTANT_MEMBER(exports, String, OC_RSRVD_DEVICE_URI);
  SET_CONSTANT_MEMBER(exports, String, OC_RSRVD_DREL);
  ...
  SET_CONSTANT_MEMBER(exports, String, OC_RSRVD_INS);
  ...
  SET_CONSTANT_MEMBER(exports, String, OC_RSRVD_LINKS);
  SET_CONSTANT_MEMBER(exports, String, OC_RSRVD_MEDIA_TYPE);
  ...
  SET_CONSTANT_MEMBER(exports, String, OC_RSRVD_PLATFORM_URI);
  SET_CONSTANT_MEMBER(exports, String, OC_RSRVD_PLATFORM_VERSION);
  SET_CONSTANT_MEMBER(exports, String, OC_RSRVD_POLICY);
  SET_CONSTANT_MEMBER(exports, String, OC_RSRVD_PRESENCE_URI);
  SET_CONSTANT_MEMBER(exports, String, OC_RSRVD_PROPERTY);
  SET_CONSTANT_MEMBER(exports, String, OC_RSRVD_RD_DISCOVERY_SEL);
  SET_CONSTANT_MEMBER(exports, String, OC_RSRVD_RD_URI);
  SET_CONSTANT_MEMBER(exports, String, OC_RSRVD_REL);
  ...
  SET_CONSTANT_MEMBER(exports, String, OC_RSRVD_RESOURCE_TYPE_RD);
  SET_CONSTANT_MEMBER(exports, String, OC_RSRVD_RESOURCE_TYPE_RDPUBLISH);
  SET_CONSTANT_MEMBER(exports, String, OC_RSRVD_RESOURCE_TYPES_URI);
  SET_CONSTANT_MEMBER(exports, String, OC_RSRVD_RTS);
  ...
  SET_CONSTANT_MEMBER(exports, String, OC_RSRVD_TITLE);
  ...
  SET_CONSTANT_MEMBER(exports, String, OC_RSRVD_URI);
