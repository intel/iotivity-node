...
_.extend( devicePrototype, {
	...
	_maybeAddResource: function( resource ) {
		...
		// If we have already seen this resource, as identified by the deviceId and the url,
	...
	updateResource: function( id, resource ) {
		...
		return this._oneShotRequest( "updateResource", this._resources[ id ], "OC_REST_PUT",
			...
			_.bind( function updateResourceFromResponse() {
				...
				// We know that when the update proves successful the remote resource will have
				// the properties we sent to it
