...
_.extend( utils.makeEventEmitter( OicDevice ).prototype, {
	...
	_startStack: function( role ) {
		...
		result = iotivity.OCInit( null, 0,
			...
			// FIXME: https://wiki.iotivity.org/security_resource_manager mentions a bug due to
			// which clients must register with OC_CLIENT_SERVER in order for security to work.
			// Look for "OC_CLIENT_SERVER" on that page.
			iotivity.OCMode[ role === "client" ? "OC_CLIENT_SERVER" :
