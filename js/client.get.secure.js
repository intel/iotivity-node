...
var intervalId,
	storageHandler = require( "../lib/StorageHandler" )(),
	handleReceptacle = {},
...
console.log( "Starting OCF stack in client-server mode: " +
...
console.log( "Initializing provisioning manager: " +
	iotivity.OCInitPM( require( "path" ).join( storageHandler._directory, "pm.db" ) ) );

var unownedDevices = [];
console.log( "Retrieving unowned devices: " +
	iotivity.OCDiscoverUnownedDevices( 30, unownedDevices ) );

console.log( "Unowned devices: " + JSON.stringify( unownedDevices, null, 4 ) );
